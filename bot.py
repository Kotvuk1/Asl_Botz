...
async def on_startup(bot: Bot) -> None:
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="addgoal",     description="🎯 Добавить цель"),
        BotCommand(command="goals",       description="Список целей"),
        BotCommand(command="goalset",     description="Обновить прогресс цели"),
        BotCommand(command="goaldone",    description="Завершить цель"),
        BotCommand(command="addhabit",    description="🔁 Добавить привычку"),
        BotCommand(command="habits",      description="Список привычек со стриками"),
        BotCommand(command="habitdone",   description="Отметить привычку выполненной"),
        BotCommand(command="stats",       description="📊 Статистика продуктивности"),
        BotCommand(command="search",      description="🔍 Поиск по задачам и памяти"),
