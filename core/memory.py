...
- Задачи и дедлайны (они хранятся в системе задач)
- Планы на конкретную неделю или месяц
...
async def extract_and_save_memories(
    ...
    # If ALL personal signals are co-located with temporal words (e.g. "завтра
    # еду к бабушке"), the LLM prompt alone is the last guard; this early exit
    # avoids the API call for obviously non-permanent messages.
